        ...
        <View style={styles.container}>
            ...
            <View style={styles.mainContainer}>
                ...
                <View style={styles.welcomeSection}>
                    ...
                    <Text style={styles.welcomeSubtitle}>Start your Islamic journey with Ihsan AI</Text>
                </View>
                ...
                <View style={styles.buttonsContainer}>
                    ...
                    {/* Sign Up Text */}
                    <TouchableOpacity onPress={() => router.dismissTo('(auth)')}>
                        <Text style={styles.signUpText}>Already have an account? <Text style={{ color: 'black' }}>Login</Text></Text>
                    </TouchableOpacity>
                </View>
            </View>
